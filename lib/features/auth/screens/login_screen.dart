    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if (state is LoginSuccess) {
          context.pushReplacementNamed(AppRouteNames.userDashboard);
        } else if (state is LoginError) {
          AppConstants.showErrorSnackbar("Login Failed!", state.msg, context);
        }
      },
                    ...
                    SubmitButton(
                        onPressed: () {
                          if (controller.text.isEmpty ||
                            ...
                            context.read<LoginBloc>().add(LoginEventStarted());
                            context.pop();
                          }
                        },
                        child: AppText(
